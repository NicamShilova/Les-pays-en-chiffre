...
Country VARCHAR(100),
Population INT,
YearlyChange DECIMAL(10,2),
NetChange INT,
Density INT,
LandArea INT,
Migrants DECIMAL(10,2),
FertRate DECIMAL(10,2),
MedAge INT,
UrbanPop INT,
WorldShare DECIMAL(10,2)
);


/* INSERT QUERY */
INSERT INTO pays(Country,Population,YearlyChange,NetChange,Density,LandArea,Migrants,FertRate,MedAge,UrbanPop,WorldShare)
VALUES
(
